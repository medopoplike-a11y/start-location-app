...
export default function MainShell() {
  ...
  // V17.8.9: Added safety timeout for profile recovery to prevent stuck loader on resume.
  ...
  // V17.8.9: Fallback to user metadata role if profile fetch failed or timed out
