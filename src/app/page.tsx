...
export default function MainShell() {
  ...
  // V17.9.3: Added safety timeout for profile recovery to prevent stuck loader on resume.
  ...
  // V17.9.3: Fallback to user metadata role if profile fetch failed or timed out
