...
function StoreContent() {
  ...
  const mapDBOrderToUI = (db: VendorDBOrder): Order => {
    ...
    return {
      ...
      prepTime: String(financials.prep_time || "15"),
      ...
      financials: db.financials ? {
        ...
        system_commission: Number(financials.system_commission || 0),
        vendor_commission: Number(financials.vendor_commission || 0),
        driver_earnings: Number(financials.driver_earnings || 0),
        insurance_fee: Number(financials.insurance_fee || 0),
        prep_time: String(financials.prep_time || "15"),
      } : undefined,
    };
  };
