...
const LoginPage = () => {
  ...
  const apkUrlV = `${FALLBACK_APK_URL.replace('start-location.apk', `start-location-v4.1.0.apk`)}`;
          ...
          <div className="space-y-4 text-sm font-mono text-left" dir="ltr">
            ...
            <div className="p-4 bg-slate-800 rounded-lg border border-slate-700">
              ...
              <p className={ (window as any).__START_FETCH_BRIDGE_ACTIVE ? "text-green-400" : "text-yellow-400" }>
                { (window as any).__START_FETCH_BRIDGE_ACTIVE ? "ULTRA ACTIVE (V4.1.0)" : "INACTIVE" }
              </p>
            </div>
