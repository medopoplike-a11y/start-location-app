  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4 mb-6">
        <button onClick={onBack} disabled={savingSettings} className="bg-white dark:bg-slate-900 p-2 rounded-xl shadow-sm text-gray-400 dark:text-slate-500 disabled:opacity-60">
      ...
      <div className="bg-white dark:bg-slate-900 p-6 rounded-[32px] border border-gray-100 dark:border-slate-800 space-y-6 shadow-sm">
        <h3 className="text-sm font-black text-gray-700 dark:text-slate-300">بيانات الملف الشخصي</h3>
        
        <div className="space-y-4">
          <div>
            <label className="text-xs font-bold text-gray-400 dark:text-slate-500 block mb-2">الاسم بالكامل</label>
            <div className="relative">
              <User className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-slate-600" />
              <input
                type="text"
                disabled={savingSettings}
                value={settingsData.name}
                onChange={(e) => onSettingsDataChange({ ...settingsData, name: e.target.value })}
                className="w-full bg-gray-50 dark:bg-slate-950 pr-12 pl-4 py-4 rounded-2xl border-none outline-none focus:ring-2 ring-emerald-500 font-bold text-gray-800 dark:text-slate-200 disabled:opacity-60"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <Phone className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-slate-600" />
              <input
                type="tel"
                disabled={savingSettings}
          ...
          <div>
            ...
            <div className="relative">
              <Mail className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-slate-600" />
              <input
                type="email"
                disabled={savingSettings}
          ...
          <div>
            ...
            <div className="relative">
              <Lock className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-slate-600" />
              <input
                type="password"
                disabled={savingSettings}
        ...
        <button
          ...
          className="w-full bg-emerald-500 text-white py-5 rounded-2xl font-bold shadow-lg shadow-emerald-100 dark:shadow-none disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
        >
          {savingSettings ? (
