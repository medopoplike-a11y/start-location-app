...
if (typeof window !== 'undefined') {
  ...
  vendorIcon = L.divIcon({
    html: `<div class="w-10 h-10 bg-red-600 rounded-full flex items-center justify-center border-4 border-white shadow-lg transform -translate-x-1/2 -translate-y-1/2">
...
export { defaultIcon, driverIcon, vendorIcon };
